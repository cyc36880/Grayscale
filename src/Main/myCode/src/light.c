...
{
    HAL_GPIO_WritePin(LED_R_GPIO_Port, LED_R_Pin, r==0 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(LED_G_GPIO_Port, LED_G_Pin, g==0 ? GPIO_PIN_SET : GPIO_PIN_RESET);
    HAL_GPIO_WritePin(LED_B_GPIO_Port, LED_B_Pin, b==0 ? GPIO_PIN_SET : GPIO_PIN_RESET);
}
